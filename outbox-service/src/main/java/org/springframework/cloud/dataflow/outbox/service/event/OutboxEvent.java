 ...
 *
 * The contents of the {@link ExportedEvent} will be replicated to
 * this entity definition and persisted to the database in order for Debezium to capture the event.
 *
